...
class mainPageVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if search_key != nil {
            ...
            let person_1 = person(id : 1, name: "카트리나", avatar: "katrina_1", photos: 1, birthday: "16/05/1983", about_gender: "30대 후반", live_place: "홍콩", aboutMe: "힌디어 영화에서 일하는 영국 여배우. 그녀의 연기력에 대한 비평가들로부터 혼합 된 리뷰를 받았음에도 불구하고, 그녀는 볼리우드에서 자신을 설립했으며 인도에서 가장 보수가 많은 여배우 중 한 명입니다.", gender: "녀성", age: "35세~40세", nickName: "얼음공주")
            partners.append(person_1)
            let person_2 = person(id : 2, name: "딜라바", avatar: "Dilraba_1", photos: 2, birthday: "03/06/1992", about_gender: "20대 후반", live_place: "딜리레바", aboutMe: "중국 배우, 모델 및 가수입니다. 그녀는 위구르족 출신이다.", gender: "녀성", age: "20세~25세", nickName: "기녀")
            partners.append(person_2)
            let person_3 = person(id : 3, name: "타만나", avatar: "tamanna_1", photos: 3, birthday: "21/12/1989", about_gender: "30대 전반", live_place: "뭄바이", aboutMe: "전문적으로 타마 나아 (Tamannaah)라고 알려진 인도의 여배우는 주로 타밀어와 텔루구어 영화에 출연한다. 그녀는 여러 힌디어 영화에도 출연했다. 연기 외에도 그녀는 무대 쇼에 참여하며 브랜드 및 제품의 저명한 유명인입니다.", gender: "녀성", age: "30세~35세", nickName: "따영")
