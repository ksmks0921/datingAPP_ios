    ...
    override func viewDidLoad() {
        ...
        if person != nil {
            sections = [
                ...
                Section(title: "自己紹介", items: [person.user_introduce!], values: [person.user_introduce!]),
                ...
                // 외모 : "신장" , "스타일", "외모", "직업"
                Section(title: "外見", items: ["身長" , "スタイル", "外見", "職業"], values: [person.user_tall!, person.user_style!, person.user_style!, person.user_job!]),
